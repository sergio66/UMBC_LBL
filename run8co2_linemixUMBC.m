function [outwave,out_array,out_linemixarray]=run8co2_linemixUMBC(...
...
%bandtype tells you which band to do eg 740 etc  
      ...
      if ((LVF == 'F') | (LVF == 'f'))
        ...
        elseif (p <= p1)  %for pressures below 100 mb, do voigt lineshape
          ...
          rRatio = raRatio(jj);
          [fhaha,yfirst,fc,rRatio] = chooserCO2(tempr,bandtype(iii),p,ps,...
          ...
          rRatio = raRatio(jj);
          [fhaha,yb,fc,rRatio] = chooserCO2(tempr,bandtype(iii),p,ps,...
