...
c NSO82 should really be eg 161 or 181 0r 171 for Water, but accept 1 for 161,2 for 181 etc
c so no need to call BD_ISO82_to_85
...
c   22  IF (MOL .EQ. 99) THEN
c         go to 99
c       END IF

C
c       IF (MOL.GT.NMOL .OR. MOL.LT.1) THEN
c          WRITE (*,'(25X,A)')
c     +    'Incorrect molecule assignment, try again'
c          GO TO 20
c       END IF
c
C
c       CALL ISO_82_TO_85 (MOL,NSO82,ISO)
c       print *,MOL,NSO82,ISO
       ISO = NSO82
C
c
c   30  WRITE (*,'(//A,/,A/)')
...
c
   ...
   32 IF (Temp .GT. 3000. .OR. Temp .LT. 70.) THEN
        WRITE (*,'(25X,A)') 'Temperature not in Range 70 - 300 K , try again'
        STOP
c        GO TO 30
      END IF
c
...
c %%% this is new!!! modified by looking at /home/sergio/SPECTRA/mass08.dat
      IF(MOL.EQ.39) THEN 
      gi = 2
      QT = 3.531400e+04
      go to 100
...
c     + 0pf7.1,////)
c      endif
c 100  print *,Mol,NSO82,Temp,QT,gi
...
c...J-P Chamapion calculations submitted to JQSRT 2008
     + 1.47210E+03, 1.61550E+03, 1.77060E+03, 1.93840E+03, 2.12020E+03,
     + 2.31720E+03, 2.53070E+03, 2.76240E+03, 3.01370E+03, 3.01370E+03,
     + 3.58230E+03, 3.90340E+03, 4.25190E+03, 4.63000E+03, 5.04020E+03,
     + 5.48530E+03, 5.96790E+03, 6.49130E+03, 7.05880E+03, 7.67390E+03,
     + 8.34040E+03, 9.06250E+03, 9.84460E+03, 1.06910E+04, 1.16080E+04,
     + 1.26000E+04, 1.36740E+04, 1.48350E+04, 1.60900E+04, 1.74470E+04,
     + 1.89140E+04, 2.05000E+04, 2.22120E+04, 2.40630E+04, 2.60610E+04,
     + 2.82180E+04, 3.05480E+04, 3.30630E+04, 3.57780E+04, 3.87080E+04,
     + 4.18710E+04, 4.52840E+04, 4.89700E+04, 5.29400E+04, 5.72300E+04,
     + 6.18600E+04, 6.68600E+04, 7.22500E+04, 7.80700E+04, 8.43500E+04,
     + 9.11300E+04, 9.84500E+04, 1.06350E+05, 1.14880E+05, 1.24080E+05,
     + 1.34030E+05, 1.44800E+05, 1.56400E+05, 1.68900E+05, 1.82400E+05,
     + 1.97000E+05, 2.12800E+05, 2.29800E+05, 2.48300E+05, 2.68200E+05,
     + 2.89700E+05, 3.12900E+05, 3.38000E+05, 3.65200E+05, 3.94500E+05,
     + 4.26000E+05, 4.60000E+05, 4.97000E+05, 5.37000E+05, 5.81000E+05,
     + 6.27000E+05, 6.78000E+05, 7.33000E+05, 7.92000E+05, 8.56000E+05,
     + 9.25000E+05, 1.00000E+06, 1.08000E+06, 1.16700E+06, 1.26100E+06,
     + 1.36200E+06, 1.47200E+06, 1.59100E+06, 1.71900E+06, 1.86000E+06,
     + 2.01000E+06, 2.17000E+06, 2.34000E+06, 2.53000E+06, 2.73000E+06,
     + 2.95000E+06, 3.18000E+06, 3.43000E+06, 3.70000E+06, 3.99000E+06,
     + 4.28557E+06/
