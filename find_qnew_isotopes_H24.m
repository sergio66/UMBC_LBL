...
if iUseDatabase < 0
  ...
  new_bt_f77 = ['!/home/sergio/SPECTRA/Global_Data_HITRAN2024/'];
  new_bt_f77 = [new_bt_f77 'TIPS_2024_allisotopes.x '];
  ...
  Q296 = mass_info(:,3)';  %% mass96, mass98 -- only have 3 columns but this is ABUNDANCE
  Q296 = mass_info(:,3)';  %% mass12.dat, mass20.dat ... remember in load_mass_iso_dat.m we SUBSET down to 3 columns
end
