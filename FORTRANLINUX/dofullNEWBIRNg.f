...
c      complex*16 arg1(no_lines),arg2(no_lines),diagL(no_lines) 
      ...
      integer zp,vp,v0p,Tp,tau2p,w_totp,ksmp,bsmp,pforp,pselfp,birnp,
...
c   do the actual computations in a subroutine
      call dofullNEWBIRN(raZ,raV,raV0,ra_Wtot,rTp,rtau2p,rpforp,rpselfp,
