...
if v12p1 > 0
  disp('doing v12.1 leastsq in PR_pipi wfunco2er')
  clear options;
  options(1) = 0; 
  options(5) = 0; options(7) = 1; options(14) = 60;
  a1a2a3_for = leastsq('wfunco2',xx,options,'wgradco2',elower,w_forr,...
                       jall,temperature,stuff);
else
  disp('doing v14 lsqnonlin in PR_pipi wfunco2er')
  clear options; options = optimset('MaxIter',1000);
  a1a2a3_for = ...
     lsqnonlin(@wfunco2,xx,[],[],options,elower,w_forr,jall,temperature,stuff);
  end
...
if v12p1 > 0
  a1a2a3_self = leastsq('wfunco2',xx,options,'wgradco2',elower,w_selfr,...
                        jall,temperature,stuff);
else
  a1a2a3_self = ...
    lsqnonlin(@wfunco2,xx,[],[],options,elower,w_selfr,jall,temperature,stuff);
  end
