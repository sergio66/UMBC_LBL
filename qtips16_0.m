...
%1.0004     0.99477      0.9964     0.99346     0.99964     0.99885     0.19185 
if gasid == 1 
    abcd = [ ... 
  ...
  1.60921e+00 , 3.63617e-01, 1.12064e-03 , -3.94979e-07 ]; 
  disp('The isotopes are 161  181  171  162  182  172  262'); 
end 
 
% fitted/actual at 296K =  
%1.003      1.0031      1.0028      1.0028      1.0029       1.003      1.0024      1.0026      1.0027      1.0023      1.0026 
if gasid == 2 
    abcd = [ ... 
...
% fitted/actual at 296K =  
%1.0003      1.0002      1.0002      1.0002      1.0003 
if gasid == 3 
    abcd = [ ... 
...
% fitted/actual at 296K =  
%1.0033     0.99989     0.99992     0.99992      0.9999 
if gasid == 4 
    abcd = [ ... 
...
% fitted/actual at 296K =  
%0.99852     0.99862     0.99866     0.99857     0.99874     0.99868 
if gasid == 5 
    abcd = [ ... 
...
% fitted/actual at 296K =  
%0.99989     0.99985     0.99989     0.99989     0.99984 
if gasid == 19 
    abcd = [ ... 
...
if gasid == 48 
    abcd = [ ... 
  -2.23042e+01 , 2.97166e+00, -5.37452e-04 , 1.26763e-06 ]; 
...
if gasid == 49 
    abcd = [ ... 
  -1.59258e+04 , 3.79934e+02, -1.87458e+00 , 5.49556e-03 ; 
  -1.72664e+04 , 4.57012e+02, -2.25058e+00 , 6.67882e-03 ]; 
