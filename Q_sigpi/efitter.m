function [elower,jall] = efitter(jq,band,elowerq,elower); 
...
if quiet > 0
  fprintf(1,'fitting for missing energy levels \n')
  end
...
pflag = quiet;
if (pflag > 0)
  plot(jq,elowerq,'+',jall,elower); pause(0.5);
  end
