...
c..  J. Fischer(a) R.R. Gamache(a&), A. Goldman(b),L.S. Rothman(c), and 
c    A. Perrin(d)
c..  
...
c..  
c..  (c)  Harvard-Smithsonian Center for Astrophysics, 60 Garden St, 
c         Cambridge, MA 02138 USA
c..  
c..  (d)  Laboratoire de Photophysique Moléculaire, Université Paris Sud, 
c         91405 Orsay, FRANCE
c..  
c..  &  Corresponding author. Email address: Robert_Gamache@uml.edu
c..  Abstract
c..  	Total internal partition sums (TIPS) are calculated for all molecular 
c       species in 
c..  the 2000 HITRAN database.  In addition, the TIPS for 13 other 
c        isotopomers/isotopologues 
c..  of ozone and carbon dioxide are presented.  The calculations address the 
c    corrections 
c..  suggested by Goldman et al. (JQSRT 2000;66:55-86).  The calculations 
c       consider the 
c..  temperature range 70-3000 K to be applicable to a variety of remote 
c       sensing needs.  
c..  The method of calculation for each molecular species is stated and 
c        comparisons with 
c..  data from the literature are discussed.  A new method of recall for the 
c       partition sums, 
c..  Lagrange 4-point interpolation, is developed.  This method, unlike 
c        previous versions of 
