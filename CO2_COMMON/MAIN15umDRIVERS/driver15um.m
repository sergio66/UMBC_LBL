...
%this section of code is identical for PQR bands of the 15 um mixing code
cc = cputime;
...
%fprintf(1,'in driver15um.m length(f_low),length(f_hi) = %6i %6i \n',length(f_low),length(f_hi))
