c compile with 
c f77 -o TIPS_2021_allisotopes.x -N109 -W -O3 TIPS_2021_allisotopes.f or
c /asl/opt/absoft/absoft10.0/bin/af77 -o TIPS_2021_allisotopes.x -N109 -W -O3 TIPS_2021_allisotopes.f
c # -N109 fold all names to upper case
c # -W    wide source file
c # -O    some optimizations
c ifort -o TIPS_2021_allisotopes.x -names uppercase -extend-source 132 -O3 TIPS_2021_allisotopes.f 
...
c      implicit DOUBLE PRECISION (a-h,o-z)
      ...
      !!!!!!! >>>>>>>>>>>>>>>>> WARNING <<<<<<<<<<<<<<<<<<<<<<<<<<<< !!!!!!!
      !!!!!!! note we modified TIPS_2021_try_include1.f to account for
...
c************************************************************************
!! this is TIPS_2021.FOR changed into a subroutine
      include 'TIPS_2021_try_include1.f'   
