...
disp('basically same as ckd_lookupBIN_FIR5.m')

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% aalways want 2901 points for kCARTA to read (gotta fix this bug)
nptsWANT = 2901;   %%% from fmin to fmax + df eg 100-3000 at 1cm-1
fcenter = 100; fmin  = 10; fmax  =  735; kaTag = 'f'; 

foutdir = '/asl/data/kcarta/H2004_otherbands.ieee-le/FIR15_30/etc.ieee-le/';
foutdir = '/asl/data/kcarta/H2008_otherbands.ieee-le/FIR15_30/etc.ieee-le/';
%foutROOT = '/asl/data/kcarta/H2012.ieee-le/';
foutdir = [foutROOT '/FIR15_30/etc.ieee-le/'];
fprintf(1,'output dir for FIR7 = %s \n',foutdir)
