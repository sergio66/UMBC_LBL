...
fcenter = 100; fmin  = 10; fmax  =  735; kaTag = 'h'; 

foutdir = '/asl/data/kcarta/H2004_otherbands.ieee-le/FIR50_80/etc.ieee-le/';
foutdir = '/asl/data/kcarta/H2008_otherbands.ieee-le/FIR50_80/etc.ieee-le/';
%foutROOT = '/asl/data/kcarta/H2012.ieee-le/';
foutdir = [foutROOT '/FIR50_80/etc.ieee-le/'];
fprintf(1,'output dir for FIR5 = %s \n',foutdir)
