...
fcenter = 2500; fmin  = 2500; fmax  = 3950; kaTag = 's';

foutdir = '/asl/data/kcarta/H2004_otherbands.ieee-le/NIR2830_3330/etc.ieee-le/';
%foutROOT = '/asl/data/kcarta/H2012.ieee-le/';
foutdir = [foutROOT '/NIR2830_3330/etc.ieee-le/'];
fprintf(1,'output dir for NIR1 = %s \n',foutdir)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
