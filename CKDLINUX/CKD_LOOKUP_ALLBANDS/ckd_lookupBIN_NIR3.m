...
fcenter = 6000; fmin  = 4000; fmax  =  9800; kaTag = 'n';  
deltav = 2.0;

foutdir = '/asl/data/kcarta/H2004_otherbands.ieee-le/NIR5550_8200/etc.ieee-le/';
%foutROOT = '/asl/data/kcarta/H2012.ieee-le/';
foutdir = [foutROOT '/NIR5550_8200/etc.ieee-le/'];
fprintf(1,'output dir for NIR3 = %s \n',foutdir)
