...
C
       INTEGER NPTABS
       REAL*8 VB3,VT3,DV3,NPT3
       REAL*8 V1ABS,V2ABS,DVABS,ABSRB(5050)
       REAL*8 O2C213(59),O2C253(59),O2C293(59)

       COMMON /CO2CT/  VB3,VT3,DV3,NPT3,O2C213,O2C253,O2C293
...
c          Only calculate if from 1340 to 1850. cm-1
         IF (((freq(NFREQ).gt.8920.0).AND.(freq(1).lt.24655.))) THEN
 ...
 50         CONTINUE                                                
            ...
            DO  J = 1, NFREQ
              ...
              IF ((freq(j) .gt. 24655.0) .or. (freq(j) .lt. 8920.0) .or.
     $          (con(j) .lt. 0.0)) then
                con(j)=0.0
                end if
              END DO
