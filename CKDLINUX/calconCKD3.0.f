...
c MODIFIED BY SCOTT HANNON SO THAT IT AGREES WITH ECMWF  Jan 2004
c /asl/data/sarta_database/Data_jan04untun/Coef/tunmlt_jan04deliv.txt
c look at columns 2,5

c by Sergio De Souza-Machado
c************************************************************************
       SUBROUTINE CALCON_MTCKD_03_loc(raCON, IDGAS,NFREQ,raFreq,FSTEP,
