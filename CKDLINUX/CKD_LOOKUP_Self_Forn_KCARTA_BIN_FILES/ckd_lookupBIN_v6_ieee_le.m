...
FNAME = '/home/sergio/SPECTRA/CKDLINUX/tunmlt_jan04deliv.dat';  %% for v4
FNAME = '/home/sergio/SPECTRA/CKDLINUX/tunmlt_iasi_may09X.dat'; %% for v6
mult = load(FNAME);
fprintf(1,'mutiplier for CKD 6 = CKD 1 * mult is at \n %s \n',FNAME);
...
oo = find(fr <= mult(1,2) | fr >= mult(length(mult),2));
multiplier(oo) = 1.0;
...
ckd = '/home/sergio/KCARTADATA/General/CKDieee_le/CKDFor6.bin';
[kf6, fr, temp] = contread(ckd);
...
ckd = '/home/sergio/KCARTADATA/General/CKDieee_le/CKDSelf6.bin';
[ks6, fr, temp] = contread(ckd);
...
plot(fr,kf4./kf1,'b',fr,kf6./kf1,'r'); title('forgn')
plot(fr,ks4./ks1,'b',fr,ks6./ks1,'r'); title('self')

plot(fr,ks4./ks6,'b'); title('self')
