...
!
            ...
            ZINT = (VNU(I)-VFT)/DV
!            print *,'sergio oprop A ',V1,V2,BOUND,NSHIFT,DV,VFT
!            print *,'sergio oprop B ',VFT,DV,I,VNU(1),VNU(I),ZINT
            BHWDXF = HWDXF/ZSLOPE
            ...
            JMIN2 = JMIN1-J2SHFT
            JMIN3 = JMIN1-J3SHFT
!            print *,'sergio oprop C ',ZINT,BHWDXF,RSHFT,JMIN1,JMIN2,JMIN3
!            print *,'sergio oprop D ',V1ABS,V2ABS,DVABS,V1,V2,DV
...
!
            DO 10 J1 = JMIN1, JMAX1               
               J2 = J1-J2SHFT
               J3 = J1-J3SHFT
!               print *,'sergio oprop loop ',J1,J2SHFT,J3SHFT,J2,J3
               ZF3 = ZF3+ZSLOPE
               ZF2 = ZF2+ZSLOPE
               ZF1 = ZF1+ZSLOPE
               IZ3 = ABS(ZF3)+1.5
