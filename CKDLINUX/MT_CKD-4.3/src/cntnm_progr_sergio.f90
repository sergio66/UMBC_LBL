...
!       argon:
        ...
        print *,' read:   N2 (typically 0.78)'
        read *, WN2
        WN2 = WN2 * W_dry
        WK(22) = WN2

        print *,' read:   O2 (typically 0.21)'
        read *, WO2
        WO2 = WO2 * W_dry
        WK(7) = WO2
...
!      WRITE (IPR,980) (WK(M),M=1,7),WBROAD
      WRITE (IPR,975) (HMOLID(I),I=1,7),HMOLID(22),HOLN2                  !A23490
      WRITE (IPR,980) (WK(M),M=1,7),WK(22),WBROAD

!
      WRITE (IPu,970) PAVE,TAVE
      WRITE (IPu,975) (HMOLID(I),I=1,7),HMOLID(22),HOLN2                  !A23490
      WRITE (IPu,980) (WK(M),M=1,7),WK(22),WBROAD
!
!      DO I = 1,60
!        print *,I,HMOLID(I)
!      END DO
  ...
  975 FORMAT (/, 9X,'GAS AMNTS (MOL/CM**2) BY LAYER (remember NO RAYLEIGH, ARGON(=0) + N2 = OTHER = WBROAD)',/, &
              9(1X,A6,3X))
  980 FORMAT (/,1P,9E10.3,//)
!
      jrad=0
!
      v1 = v1abs
