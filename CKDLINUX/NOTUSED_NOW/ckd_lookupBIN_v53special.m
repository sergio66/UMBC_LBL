...
%     call it CKD 53 as it is a hybrid .... uses latest estimates from
%                    /WATER/CONTINUUM
...
CKD=53;     %sergio
fname = '/home/sergio/KCARTADATA/General/CKDieee_le/CKDSelf53.bin';
...
fname2 = '/asl/data/kcarta/KCARTADATA/General/CKDieee_le/CKDSelf53.bin';
...
CKD=53;     %sergio
fname = '/home/sergio/KCARTADATA/General/CKDieee_le/CKDFor53.bin';
fid=fopen(fname,'w','ieee-le');
...
fname2 = '/asl/data/kcarta/KCARTADATA/General/CKDieee_le/CKDFor53.bin';
copier = ['!cp ' fname '  '  fname2];
eval([copier]);
