...
fcenter = 40000; fmin  = 20000; fmax  =  49000; kaTag = 'u';  
deltav = 10.0;

foutdir = '/asl/data/kcarta/H2004_otherbands.ieee-le/UV25000_45000/etc.ieee-le/';
%foutROOT = '/asl/data/kcarta/H2012.ieee-le/';
foutdir = [foutROOT '/UV25000_45000/etc.ieee-le/'];
fprintf(1,'output dir for UV = %s \n',foutdir)
