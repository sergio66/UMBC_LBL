...
fcenter = 14000; fmin  = 10000; fmax  =  29000; kaTag = 'v';  
deltav = 5.0;

foutdir = '/asl/data/kcarta/H2004_otherbands.ieee-le/VIS12000_25000/etc.ieee-le/';
%foutROOT = '/asl/data/kcarta/H2012.ieee-le/';
foutdir = [foutROOT '/VIS12000_25000/etc.ieee-le/'];
fprintf(1,'output dir for VIS1 = %s \n',foutdir)
