...
fcenter = 100; fmin  = 50; fmax  =  775; kaTag = 'j'; 

%foutROOT = '/asl/data/kcarta/H2012.ieee-le/';
foutdir = '/asl/data/kcarta/H2004_otherbands.ieee-le/FIR80_150/etc.ieee-le/';
foutdir = [foutROOT '/FIR80_150/etc.ieee-le/'];
fprintf(1,'output dir for FIR4 = %s \n',foutdir)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
