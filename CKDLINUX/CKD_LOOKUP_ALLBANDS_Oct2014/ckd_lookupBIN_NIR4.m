...
fcenter = 8000; fmin  = 6000; fmax  =  14000; kaTag = 'o';  
deltav = 2.5;

foutdir = '/asl/data/kcarta/H2004_otherbands.ieee-le/NIR8250_12250/etc.ieee-le/';
%foutROOT = '/asl/data/kcarta/H2012.ieee-le/';
foutdir = [foutROOT '/NIR8250_12250/etc.ieee-le/'];
fprintf(1,'output dir for NIR4 = %s \n',foutdir)
