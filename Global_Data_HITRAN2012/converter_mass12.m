...
%% copied from /home/sergio/SPECTRA/Global_Data_HITRAN2008/converter_mass08.m
...
gasMax = 47;
if length(boo) ~= gasMax
  error('oops : did not find 47 gases!!!')
  end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fid = fopen(fout,'w');
%fprintf(fid,' \% see /home/sergio/SPECTRA/Global_Data_HITRAN2012/converter_mass08.m \n');
