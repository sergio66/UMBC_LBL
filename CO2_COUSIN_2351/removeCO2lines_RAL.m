...
% THE MAIN sigsig, pipi and deltdelt lines are not computed .. RUN1.m
% can then do data fits by calling appropriate codes !!
...
%    fprintf(1,'\n found a band !! \n');
    ...
    tempPQRlines=makeDAVEhitlin(band,vers,strengthM,fname);
