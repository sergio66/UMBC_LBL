function [voimix]=voigtmixRatio(iii,freqq,f,ymix,temperature,w_forq,...
                                w_selfq,strenqt,NIF,birn,ratio); 

%this is really the same as VoigtMixRatio.m used in run6co2 LBL code
...
voimix=doVmixRatio(f,freqq_shift,w_tot,temperature,duration,...
              ...
              K_voigt_mixing,K_lorentz_mixing,bsm,birnbirn,NIFNIF,ratio);
