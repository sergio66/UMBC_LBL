      subroutine vhh1(wr,v,v0,Temp,m,brd,n_in)
...
c            wi1(ii)=wi1(ii)+C(jj)*(d2+d4)+S(jj)*(d1-d3)
 60         CONTINUE
 50       CONTINUE
        end if
...
c            wi2(ii)=wi2(ii)+C(jj)*(d2+d4)+S(jj)*(d1-d3)
 90         CONTINUE
 80       CONTINUE
        end if
