...
c   end
      ...
      real*8 z(n_in),v(n_in),v0,T,tau2,w_tot,dd
      integer n_in
...
c see birn_lookupNEW.m
       open(unit=IOUN,FILE='../FORTRANFILES/bbiirrnn.dat',STATUS='OLD',
     $                                   FORM='UNFORMATTED')

c this uses the symmetric functions that Scott Hannon thinks to use
c see birn_lookupNEW2.m
c      open(unit=IOUN,FILE='../FORTRANFILES/bbiirrnn2.dat',STATUS='OLD',
c     $                                   FORM='UNFORMATTED')
