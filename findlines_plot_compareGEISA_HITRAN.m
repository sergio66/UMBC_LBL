...
figure(1); clf; semilogy(line1.wnum,line1.stren,'b.'); title(num2str(GEISA)); 
  fprintf(1,'GEISA  %4i has %6i lines \n',GEISA,length(line1.wnum))
ax1 = axis;
figure(2); clf; semilogy(line2.wnum,line2.stren,'r.'); title(num2str(HITRAN)); 
...
figure(2); semilogy(line2.wnum(oo2(oo21(wah))),line2.stren(oo2(oo21(wah))),'rx',line1.wnum(oo1(wah)),line1.stren(oo1(wah)),'b.'); grid
    title(['STREN iso=1 (r)' num2str(HITRAN) '(b)' num2str(GEISA)]); 
disp('ret')
...
if length(I) > 0
  ...
  semilogy(line2.wnum,line2.stren,'r.',line1.wnum,line1.stren,'bo'); grid
    title(['STREN (b)' num2str(GEISA) ' (r)' num2str(HITRAN)]);
  figure(4); clf
    ...
    oo1 = find(line1.iso == 3);     oo2 = find(line2.iso == 3);      
      ...
      hold off
    str1a = [num2str(HITRAN) ' iso1'];     str1b = [num2str(GEISA) ' iso1'];
    str2a = [num2str(HITRAN) ' iso2'];     str2b = [num2str(GEISA) ' iso2'];
    str3a = [num2str(HITRAN) ' iso3'];     str3b = [num2str(GEISA) ' iso3'];    
  ...
  elseif iDo > 0
    ...
    title(['STREN ' num2str(HITRAN) '-' num2str(GEISA)]); 
    grid on
  end

  figure(5);
  semilogy(line2.wnum,line2.abroad,'r.',line1.wnum,line1.abroad,'bo'); grid
    title(['ABROAD (b)' num2str(GEISA) ' (r)' num2str(HITRAN)]); 
  ...
  semilogy(line2.wnum,line2.sbroad,'r.',line1.wnum,line1.sbroad,'bo'); grid
    title(['SBROAD (b)' num2str(GEISA) ' (r)' num2str(HITRAN)]); 
